    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form method="POST" action="{{ route('project.update.post', ['id' => $id]) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input id="name_prj" type="text" class="form-control @error('name_prj') is-invalid @enderror"
                               name="name_prj" value="{{ str_replace('_', ' ',$project->name_prj) }}" maxlength="28"
                               size="28" required autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="desc_prj" type="text" class="form-control @error('desc_prj') is-invalid @enderror"
                                  ...
                                  style="max-height: 350px; min-height: 100px;">{{ $project->desc_prj }}</textarea>
                        ...
                        <select id="id_mode" class="form-control" name="id_mode" data-toggle="tooltip"
                            ...
                            @foreach ($sessionModes as $sessionMode)
                                <option value="{{$sessionMode->id_mode}}"
                                        @if($sessionMode->id_mode == $project->id_mode) selected @endif>
                    ...
                    <div class="form-group">
                        ...
                        <input id="limit_prj" type="number" class="form-control" name="limit_prj"
                               value="{{ $project->limit_prj }}" min="0" max="3600" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control test" id="toggle-event" name="selectexperts" type="checkbox"
                                        ...
                                        <button type="button" class="btn btn-primary" data-toggle="button"
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       @if(in_array($expert->id_exp, $idExpertsParticipation))
                                                       checked="checked"
                                                        @endif
                                                >
